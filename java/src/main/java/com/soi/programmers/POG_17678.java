...
public class POG_17678 {
    public static void main(String[] args) {
//        String solution = new POG_17678().solution(1, 1, 5, new String[]{"08:00", "08:01", "08:02", "08:03"});
        String solution = new POG_17678().solution(2, 10, 2, new String[]{"09:10", "09:09", "08:00"});
