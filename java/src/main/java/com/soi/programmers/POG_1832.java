...
public class POG_1832 {
    ...
    public static void main(String[] args) {
        int solution = new POG_1832().solution(3, 6, new int[][]{{0, 2, 0, 0, 0, 2}, {0, 0, 2, 0, 1, 0}, {1, 0, 0, 2, 2, 0}});
//        int solution = new POG_1832().solution(3, 3, new int[][]{{0, 0, 0}, {0, 0, 0}, {0, 0, 0}});
    }
