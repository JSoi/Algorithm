...
public class POG_142085 {
    static int[] enemyArr;
    static int answer = 0;

    public static void main(String[] args) throws Exception {
        Assertions.check(new POG_142085().solution(7, 3, new int[]{4, 2, 4, 5, 3, 3, 1}), 5);
        Assertions.check(new POG_142085().solution(10, 1, new int[]{2, 2, 2, 2, 2, 10}), 6);
    }
