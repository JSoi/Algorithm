...
public class POG_340212 {
    public static void main(String[] args) {
        int solution = new POG_340212().solution(new int[]{1, 5, 3}, new int[]{2, 4, 7}, 30);
//        int solution = new POG_340212().solution(new int[]{1, 99999, 100000, 99995}, new int[]{9999, 9001, 9999, 9001}, 3456789012L); // 39354
