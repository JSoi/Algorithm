...
public class POG_178870 {
    public static void main(String[] args) {
        int[] case1 = new POG_178870().solution(new int[]{1, 2, 3, 4, 5}, 7);
        int[] case2 = new POG_178870().solution(new int[]{1, 1, 1, 2, 3, 4, 5}, 5);
        int[] case3 = new POG_178870().solution(new int[]{2, 2, 2, 2, 2}, 6);
