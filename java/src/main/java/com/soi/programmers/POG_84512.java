...
public class POG_84512 {
    final char[] characters = new char[]{'A', 'E', 'I', 'O', 'U'};
    final Map<Character, Integer> characterMap = Map.of('A', 0, 'E', 1, 'I', 2, 'O', 3, 'U', 4);

    public static void main(String[] args) {
        int solution = new POG_84512().solution("AAAAE");
        int solution2 = new POG_84512().solution("AAAE");
        int solution3 = new POG_84512().solution("I");
        int solution4 = new POG_84512().solution("EIO");
