...
public class L68935 {
    public static void main(String[] args) throws Exception {
        Assertions.check(new L68935().solution(45), 7);
        Assertions.check(new L68935().solution(125), 229);

        Assertions.check(new L68935().solution2(45), 7);
        Assertions.check(new L68935().solution2(125), 229);
    }
