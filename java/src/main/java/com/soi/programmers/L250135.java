...
public class L250135 {
    public static void main(String[] args) throws Exception {
        Assertions.check(new L250135().solution(0, 5, 30, 0, 7, 0), 2);
        Assertions.check(new L250135().solution(12, 0, 0, 12, 0, 30), 1);
        Assertions.check(new L250135().solution(0, 6, 1, 0, 6, 6), 0);
        Assertions.check(new L250135().solution(11, 59, 30, 12, 0, 0), 0);
        Assertions.check(new L250135().solution(11, 58, 59, 11, 59, 0), 1);
        Assertions.check(new L250135().solution(1, 5, 5, 1, 5, 6), 2);
        Assertions.check(new L250135().solution(0, 0, 0, 23, 59, 59), 2852);
